...
SC_API __nonnull((2)) __attr_access((__read_only__, 2))
...
SC_API __attr_access((__read_only__, 2)) __attr_access((__read_only__, 4))
...
SC_API __nonnull((3)) __attr_access((__read_only__, 1))
...
SC_API __THROW __attribute_noinline__ __attr_access((__write_only__, 1, 2))
int sc_save_backtrace (void **frames, int size, int skip);
SC_API __nonnull((1, 3)) __attr_access((__read_only__, 1, 2))
...
SC_API __nonnull((1, 2)) __attr_access((__read_only__, 1))
...
SC_API __attribute_noinline__ __nonnull((1))
...
SC_API __nonnull((1)) __attr_access((__read_only__, 2))
